...
<div class="container-fluid">
    ...
    if (isset($_GET['id'])) {
        ...
        if ($stmt) {
            ...
            if ($result && $demande = mysqli_fetch_assoc($result)) {
    ?>
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Lecture du message de
                            <span class="text-black">
                             ...
                             <a href="demande.php" class="text-end btn btn-danger btn-sm float-right">Retour</a></h6>
                    </div>
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8 flex-column">
                                  <h3>Message</h3>
                                    <span class="text-primary" ><?= $demande['message'] ?></span>
                                </div>
                                <div class="col-md-4 border-left-dark">
                                    <h3>Type de Service : <span class="text-primary" ><?= $demande['service_type'] ?></span> </h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        Date de reception : <h6><?= $demande['created_at'] ?></h6>
                    </div>
                </div>
    <?php
            } else {
