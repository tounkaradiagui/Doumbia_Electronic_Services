       ...
       <!-- Footer-->
    <footer class="footer bg-dark position-relative pb-4 pt-md-3 py-lg-4 py-xl-5 mt-4">
      ...
      <div class="container position-relative z-2 pt-5 pb-2" data-bs-theme="dark">
        ...
        <div class="row" id="links">
          ...
          <div class="col-md-3 col-xl-2 pb-2 pb-md-0">
            <h3 class="h6 text-uppercase d-none d-md-block">Catégories</h3>
          ...
          <div class="col-md-3 pb-2 pb-md-0">
            <h3 class="h6 text-uppercase d-none d-md-block">Adresse</h3>
            ...
            <div class="collapse d-md-block" id="showroom" data-bs-parent="#links">
              <ul class="nav flex-column pb-3">
                <li class="nav-item">
                  <a class="nav-link fw-normal px-0 py-1" href="#"><?= siteConfig('address') ?? "Mon adresse"; ?></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link fw-normal px-0 py-1" href="mailto:<?= siteConfig('email') ?? "Email"; ?>"><?= siteConfig('email') ?? "Email"; ?></a>
                </li>
                <li class="nav-item">
          ...
          <div class="col-12 col-xl-3 mt-md-2 mt-xl-0 pt-2 pt-md-4 pt-xl-0">
            <h3 class="h6 text-uppercase mb-1 pb-1">Télécharger l'application</h3>
        ...
        <div class="d-sm-flex align-items-end justify-content-between border-bottom mt-2 mt-sm-1 pt-4 pt-sm-5">
          ...
          <nav class="nav d-flex mb-3 mb-sm-4">
            ...
            <a class="nav-link text-body-secondary fs-sm fw-normal ps-0 pe-2 py-2 me-4" href="#">Confidentialité</a>
            <a class="nav-link text-body-secondary fs-sm fw-normal ps-0 pe-2 py-2 me-sm-4" href="#">Termes et conditions d'utilisations</a>
          </nav>
        ...
        <div class="d-sm-flex align-items-center pt-4">
          <div class="d-sm-flex align-items-center pe-sm-2">
            <a class="navbar-brand d-inline-flex align-items-center me-sm-5 mb-4 mb-sm-0" href="index-2.html">
...
<!-- Mirrored from around.createx.studio/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Nov 2023 19:06:11 GMT -->
