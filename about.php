...
<section class="bg-dark position-relative overflow-hidden py-5">
  ...
  <div class="container position-relative z-2 pt-3 pb-sm-3 pt-sm-4 py-md-5 my-lg-2 my-xl-3 my-xxl-4" data-bs-theme="dark">
    <div class="row align-items-center py-xxl-2" data-aos="fade-up" data-aos-duration="600" data-aos-offset="300" data-disable-parallax-down="md">
      <div class="col-md-6 pb-3 pb-md-0 mb-3 mb-md-0">
        <img src="./assets/img/laptop.jpg" width="620" alt="Image">
      </div>
      <div class="col-md-6 col-lg-5 col-xxl-4 offset-lg-1" data-aos="fade-up" data-aos-duration="850" data-aos-offset="200" data-disable-parallax-down="md">
        <div class="ps-md-4 ps-lg-0">
          <h2 class="mb-lg-4">Bienvenue chez <?= siteConfig('title') ?? "Diagui TOUNKARA"; ?>, où la créativité rencontre l'excellence. </h2>
          <p class="text-body pb-lg-2 mb-xl-4">
            Votre succès est notre priorité. En tant que prestataires de
            services professionnels, nous nous engageons à fournir des
            solutions sur mesure pour répondre à vos besoins. Explorez notre univers et découvrez ce
            qui nous rend uniques..
          </p>
          <a class="btn btn-lg btn-link px-0" href="#benefits">
            Continuer
...
<!-- Benefits -->
<section class="container pt-5 mt-md-3 mt-lg-2 mt-xl-4 mt-xxl-5" id="benefits">
  <h2 class="h1 text-center pt-3 pt-sm-4 pt-lg-5 pb-3 mb-3 mb-lg-4 mt-xl-3">Nos avantages</h2>
        ...
        <div class="card-flip-inner">
          <div class="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
            <div class="card-body text-center">
              ...
              <p class="card-text">
                Les utilisateurs et partenaires peuvent compter sur une assistance technique 24h/24 et 7j/7, ainsi que sur l'aide du service d'analyse technique.
              </p>
            </div>
          </div>
          <div class="card-flip-back bg-primary rounded-5 py-2 py-lg-4 px-0">
            <div class="card-body text-center">
              ...
              <div class="h3 display-4 text-white pb-1 mb-2">24h/7</div>
        ...
        <div class="card-flip-inner">
          <div class="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
            <div class="card-body text-center">
              ...
              <p class="card-text">
                Notre engagement envers la sécurité des données est notre priorité absolue. Nous mettons en œuvre des mesures robustes pour protéger les informations de nos clients et utilisateurs.
              </p>
            </div>
          </div>
          <div class="card-flip-back bg-danger rounded-5 py-2 py-lg-4 px-0">
            <div class="card-body text-center">
              ...
              <p class="card-text text-white opacity-70">
                Votre Confidentialité, Notre Priorité. Vos informations personnelles sont entre de bonnes mains, car nous nous efforçons constamment d'assurer un environnement sûr et fiable. </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-flip-inner">
          <div class="card-flip-front bg-secondary rounded-5 py-2 py-lg-4 px-0">
            <div class="card-body text-center">
              ...
              <h3>Fiabilité</h3>
              <p class="card-text">
                Grâce à notre plateforme, développée à l'aide de méthodes avancées de gestion des données, la qualité des données atteint 100 %, soit 20 % meilleure que les autres plateformes.
              </p>
            </div>
          </div>
...
<section class="container overflow-hidden py-5 my-md-3 my-lg-2 my-xl-4 my-xxl-5">
  <div class="row align-items-center my-2 py-2 py-sm-4 py-lg-5 my-xxl-2">
    <div class="col-md-5 text-center text-md-start pe-md-5 pe-lg-0 pe-xxl-4 ps-xl-5 mb-5 mb-md-0">
      <h2 class="h1 pb-3 pb-xl-2 mb-lg-4 mb-xl-5">Rejoignez <?= siteConfig('title') ?? "Diagui TOUNKARA"; ?> avec vos outils préférés.</h2>
    </div>
